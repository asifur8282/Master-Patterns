...
function getAst013Code(rows, sp, symbol, lang) {
  ...
  const pyLines = [
    ...
    { code: `    left_spaces = "${h.unitSpaces}" * ((rows - i - 1) // 2)`, explanation: "Calculate left spacer." },
    { code: `    lobe1 = (symbol + "${h.spaces}") * i`, explanation: "Left lobe." },
    { code: `    mid_spaces = "${h.unitSpaces}" * (rows - i)`, explanation: "Center spacer." },
    ...
    { code: `    spaces = "${h.unitSpaces}" * (rows - i)`, explanation: "Centering spacer." },
  ...
  const jsLines = [
    ...
    { code: `    const leftSpaces = "${h.unitSpaces}".repeat(Math.floor((rows - i - 1) / 2));`, explanation: "Left spacing." },
    { code: `    const lobe1 = (symbol + "${h.spaces}").repeat(i);`, explanation: "Left lobe." },
    { code: `    const midSpaces = "${h.unitSpaces}".repeat(rows - i);`, explanation: "Center spacing." },
    ...
    { code: `    const leftSpaces = "${h.unitSpaces}".repeat(rows - i);`, explanation: "Centering spaces." },
